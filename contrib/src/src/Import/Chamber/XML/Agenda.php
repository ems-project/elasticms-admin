...
class Agenda extends Model
{
    ...
    public function __construct(array $data, Import $import)
    {
        ...
        $this->source['id_agenda'] = $this->source['type_agenda'].$this->date->format('YmdHi');
        ...
        parent::__construct($import, Model::TYPE_MTNG, $this->source['type_agenda'].$this->date->getTimestamp());
    }
