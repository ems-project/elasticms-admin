...
class FLWBDoc
{
    ...
    public function __construct(FLWB $flwb, Import $import, array $data)
    {
        $this->flwb = $flwb;
    ...
    {
        return $this->source['number_doc'] === '1' && $this->source['owner_code'] === 'K';
    }
    ...
    {
        return array_filter(array_merge([$this->source['doc_type']], $this->subDocTypes), [Model::class, 'arrayFilterFunction']);
    }
    ...
    protected function getRootElements(): array
    {
        return [
            ...
            'MAINDOC_JOINTDOCS', 'AUTEURM', 'SUBDOCS', 'EXCADUC'
        ];
    }
