...
class SearchCategories
{
    ...
    public static function forFLWB(FLWB $flwb): array
    {
        ...
        self::catFlwbAmendment($flwb, $categories);
        self::catFlwbStateAdvise($flwb, $categories);
        self::catFlwbCommissionReport($flwb, $categories);
    ...
    private static function catFlwbNaturalization(FLWB $flwb, array &$categories): void
    {
        if ($flwb->inMainDocTypes(FLWBDoc::DOC_TYPE_NATURALIZATION)) {
            $categories[] = self::CAT_FLWB_NATURALIZATION;
        }
    }
    ...
    private static function catFlwbAmendment(FLWB $flwb, array &$categories): void
    {
        if ($flwb->inDocTypes(FLWBDoc::DOC_TYPE_AMENDMENT)) {
            $categories[] = self::CAT_FLWB_AMENDMENT;
        }
    }
    ...
    private static function catFlwbCommissionReport(FLWB $flwb, array &$categories): void
    {
        if ($flwb->inDocTypes(FLWBDoc::DOC_TYPE_COMMISSION_REPORT)) {
            $categories[] = self::CAT_FLWB_COMMISSION_REPORT;
        }
    }
