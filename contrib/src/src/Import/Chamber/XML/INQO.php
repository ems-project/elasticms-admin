...
class INQO extends Model implements ParentDocument
{
    ...
    public function __construct(SplFileInfo $file, Import $import, StorageManager $storageManager, AssetExtractorService $extractorService, FileService $fileService)
    {
        ...
        $this->source['id_inqo_short'] = substr($this->source['id_inqo'], -4);
        $this->source['id_number'] = intval(substr($this->source['id_inqo'], -4));
    ...
    protected function getCallbacks(): array
    {
        ...
        return [
            ...
            'DOSSIERNR' => ['source', 'number_case', $intCallback],
    ...
    protected function parseINQOJOINTKEYS(array $value): void
    {
