 ...
 * }
 * @psalm-type EmsAdminUiConfig = array<mixed>
 ...
 *     etag_hash_algo?: scalar|null|Param,
 *     asset_local_folder?: scalar|null|Param,
 *     search_limit?: int|Param, // search limit to get local documents // Default: 1000
 *     templates?: array{
 *         error?: scalar|null|Param, // Default: "@EMSCH/template/error{code}.html.twig"
 *         ems_link?: scalar|null|Param, // Default: "@EMSCH/template/emsLinks/{type}.ems_link.twig"
 *     },
 *     elasticms?: list<array{ // name for the ems-project // Default: []
 *         hosts: mixed, // elasticsearch hosts
 *         default?: bool|Param,
 *         translation_type?: scalar|null|Param, // example: 'test_i18n' // Default: null
 *         route_type?: scalar|null|Param, // Default: null
 *         asset_config_type?: scalar|null|Param, // Default: null
 *         templates?: mixed,
 *         api?: mixed, // api for content exposing
 *         search_config?: mixed,
 *     }>,
 *     api?: list<array{ // name for the ems-project // Default: []
 *         url: scalar|null|Param, // url of the elasticms without /api
 *         key: scalar|null|Param, // api key
 *     }>,
 *     user_api?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         url: scalar|null|Param, // url of the elasticms without /user_api
 *     },
 *     local?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         path?: scalar|null|Param,
 *     },
 *     security?: array{
 *         route_login?: scalar|null|Param, // Default: "emsch_login"
 *         firewall?: scalar|null|Param, // Default: null
 *         sso?: array{
 *             core_user?: scalar|null|Param, // Default: false
 *             oauth2?: bool|array{
 *                 enabled?: bool|Param, // Default: false
 *                 provider?: scalar|null|Param, // Default: "keycloak"
 *                 auth_server?: scalar|null|Param,
 *                 realm?: scalar|null|Param,
 *                 client_id?: scalar|null|Param,
 *                 client_secret?: scalar|null|Param,
 *                 redirect_uri?: scalar|null|Param,
 *                 scopes?: mixed, // Default: ["openid","profile","offline_access"]
 *                 version?: scalar|null|Param,
 *                 encryption_algorithm?: scalar|null|Param,
 *                 encryption_key?: scalar|null|Param,
 *             },
 *             saml?: bool|array{
 *                 enabled?: bool|Param, // Default: false
 *                 sp_entity_id?: scalar|null|Param,
 *                 sp_public_key?: scalar|null|Param,
 *                 sp_private_key?: scalar|null|Param,
 *                 idp_entity_id?: scalar|null|Param,
 *                 idp_public_key?: scalar|null|Param,
 *                 idp_sso?: scalar|null|Param,
 *                 security?: mixed,
 *             },
 *         },
 *     },
 ...
 *     hash_algo?: scalar|null|Param, // Default: "sha1"
 *     backend_url?: scalar|null|Param, // Default: null
 *     backend_api_key?: scalar|null|Param, // Default: null
 *     elasticsearch_proxy_api?: scalar|null|Param, // Default: false
 *     elasticsearch_connection_pool?: scalar|null|Param, // Default: null
 ...
 *     vite_dev_server?: scalar|null|Param, // Default: null
 *     cache?: array{
 *         type?: scalar|null|Param, // Default: "file_system"
 *         prefix?: scalar|null|Param, // Default: "ems_cache"
 *         redis?: array{
 ...
 *         verify?: scalar|null|Param, // Default: true
 *     },
 *     metric?: array{
 *         enabled?: scalar|null|Param,
 *         host?: scalar|null|Param,
 *         port?: scalar|null|Param, // Default: null
 *     },
 *     webalize?: array{
 *         removable_regex?: scalar|null|Param, // Default: "/([^a-zA-Z0-9_| \\-.'\\/])|(\\.$)/"
 *         dashable_regex?: scalar|null|Param, // Default: "/[\\/| ']+/"
 *     },
 *     request?: array{
 ...
 *     paging_size?: scalar|null|Param, // Default: 20
 *     circles_object?: scalar|null|Param, // Default: null
 *     shortname?: scalar|null|Param, // Default: "e<b>ms</b>"
 *     name?: scalar|null|Param, // Default: "elastic<b>ms</b>"
 *     theme_color?: scalar|null|Param, // Default: "blue"
 *     date_time_format?: scalar|null|Param, // Default: "j/m/Y \\a\\t G:i"
 *     date_format?: scalar|null|Param, // Default: "j/m/Y"
 *     time_format?: scalar|null|Param, // Default: "G:i:s"
 *     instance_id?: scalar|null|Param, // Default: "ems_"
 *     datepicker_format?: scalar|null|Param, // Default: "dd/mm/yyyy"
 *     datepicker_weekstart?: scalar|null|Param, // Default: 1
 *     elasticsearch_cluster?: mixed, // Default: ["http://localhost:9200"]
 *     datepicker_daysofweek_highlighted?: mixed, // Default: [[0,6]]
 *     from_email?: array{
 *         address?: scalar|null|Param, // Default: "noreply@example.com"
 *         sender_name?: scalar|null|Param, // Default: "elasticms"
 *     },
 *     notification_pending_timeout?: scalar|null|Param, // Default: "P0Y0M15DT0H0M0S"
 *     trigger_job_from_web?: scalar|null|Param, // Default: true
 *     lock_time?: scalar|null|Param, // Default: "+1 minutes"
 *     asset_config?: mixed, // Default: []
 *     private_key?: scalar|null|Param, // Default: null
 *     public_key?: scalar|null|Param, // Default: null
 *     tika_server?: scalar|null|Param, // Default: null
 *     tika_max_content?: scalar|null|Param, // Default: 5120
 *     elasticsearch_version?: scalar|null|Param, // Default: "depreacted"
 *     pre_generated_ouuids?: bool|Param, // Default: false
 *     template_options?: list<mixed>,
 *     health_check_allow_origin?: scalar|null|Param, // Default: null
 *     tika_download_url?: scalar|null|Param, // Default: null
 *     default_bulk_size?: scalar|null|Param, // Default: 500
 *     url_user?: scalar|null|Param, // Default: null
 *     clean_jobs_time_string?: scalar|null|Param, // Default: "-7 days"
 *     custom_user_options_form?: scalar|null|Param, // Default: null
 *     template_namespace?: scalar|null|Param, // Default: "EMSCore"
 *     dynamic_mapping?: scalar|null|Param, // Default: "false"
 *     image_max_size?: scalar|null|Param, // Default: 2048
 *     forgot_password_url?: scalar|null|Param, // Default: null
 *     group_feature?: bool|Param, // Default: false
 *     security?: array{
 *         firewall?: array{
 *             core?: scalar|null|Param, // Default: "ems_core"
 *             api?: scalar|null|Param, // Default: "ems_core_api"
 *         },
 *     },
 *     ldap?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         dn_string?: scalar|null|Param,
 *         base_dn?: scalar|null|Param,
 *         search_dn?: scalar|null|Param,
 *         search_password?: scalar|null|Param,
 *         default_roles?: mixed,
 *         uid_key?: scalar|null|Param,
 *         filter?: scalar|null|Param,
 *         password_attribute?: scalar|null|Param,
 *         extra_fields?: mixed,
 *         email_field?: scalar|null|Param,
 *         display_name_field?: scalar|null|Param,
 *     },
 *     async?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *     },
 * }
 * @psalm-type EmsFormConfig = array{
 *     hashcash_difficulty?: mixed, // Default: 16384
 *     endpoints?: mixed, // Default: []
 *     instance?: array{
 *         type?: scalar|null|Param, // Default: "form_instance"
 *         type_form_field?: scalar|null|Param, // Default: "form_structure_field"
 *         type_form_markup?: scalar|null|Param, // Default: "form_structure_markup"
 *         type_form_subform?: scalar|null|Param, // Default: "form_structure"
 *         type_form_choice?: scalar|null|Param, // Default: "form_choice"
 *         type_form_validation?: scalar|null|Param, // Default: "form_validation"
 *         form_field?: scalar|null|Param, // Default: "form"
 *         form_subform_field?: scalar|null|Param, // Default: "sub_form"
 *         form_template_field?: scalar|null|Param, // Default: "form_template"
 *         theme_field?: scalar|null|Param, // Default: "theme_template"
 *         submission_field?: scalar|null|Param, // Default: "submissions"
 *         domain?: scalar|null|Param, // Default: "domain"
 *         name?: scalar|null|Param, // Default: "name"
 *         load_from_json?: scalar|null|Param, // Default: false
 *         cacheable?: scalar|null|Param, // Default: true
 *     },
 * }
 * @psalm-type EmsSubmissionConfig = array{
 *     default_timeout?: scalar|null|Param, // Default: "10"
 *     connections?: mixed,
 * }
 ...
 *     "when@db"?: array<string, RouteConfig|ImportConfig|AliasConfig>,
 *     "when@dev"?: array<string, RouteConfig|ImportConfig|AliasConfig>,
 *     "when@prod"?: array<string, RouteConfig|ImportConfig|AliasConfig>,
 *     "when@redis"?: array<string, RouteConfig|ImportConfig|AliasConfig>,
 *     "when@store_data"?: array<string, RouteConfig|ImportConfig|AliasConfig>,
